...
def genRTPs(stats):
    ...
    data['gamemodule'].append('base game car')
    data['rtp'].append(float(stats['baseGameCar']['rtp']) * 100)
    
    data['gamemodule'].append('free game car')
    data['rtp'].append(float(stats['freeGameCar']['rtp']) * 100)
    
    data['gamemodule'].append('instant wins')
    data['rtp'].append(float(stats['instantWins']['rtp']) * 100)
    
    data['gamemodule'].append('instant wins car')
    data['rtp'].append(float(stats['instantWinsCar']['rtp']) * 100)
